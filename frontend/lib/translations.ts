...
export const zhTranslations: Record<string, string> = {
  ...
  'biz.enclosure.label.compareDesc':
  ...
  'biz.enclosure-detail.context.combinedDesc':
    '全渠道合并，展示每围场的活跃学员、付费、参与率、动员率综合表现',

  // ── biz Cohort 热力图 ────────────────────────────────────────────────────────
  'biz.cohort-heatmap.title': 'Cohort 留存热力图',
  'biz.cohort-heatmap.subtitle':
  ...
  'biz.leads-overview.section.enclosure_baseline':
    '围场效率历史偏差 Enclosure Efficiency vs Baseline',
  ...
  // ── 指标矩阵页 ───────────────────────────────────────────────────────────────
  'matrix.title': '指标矩阵总览',
  'matrix.subtitle': 'CC/SS/LP 三岗位指标覆盖范围配置与对比',
  'matrix.category.result': '结果指标',
  'matrix.category.achievement': '达成指标',
  'matrix.category.process': '过程指标',
  'matrix.category.efficiency': '效率指标',
  'matrix.category.process_wide': '宽口过程指标',
  'matrix.category.conversion': '转化效率',
  'matrix.category.service_pre_paid': '服务指标-付费前外呼',
  'matrix.category.service_post_paid': '服务指标-付费后外呼',
  'matrix.pending': '数据待接入',
  'matrix.cc_readonly': 'CC 列由系统锁定，全量启用',
  'matrix.save': '保存配置',
  'matrix.reset': '重置',
  'matrix.export': '导出 CSV',
};
...
export const thTranslations: Record<string, string> = {
  ...
  'root.label.noAnalysisData':
    'ยังไม่มีข้อมูลวิเคราะห์ — กดปุ่ม «เรียกใช้การวิเคราะห์» ที่มุมขวาบน',
  ...
  'snapshots.label.noWeeklyData':
    'ยังไม่มีข้อมูลเปรียบเทียบรายสัปดาห์ ต้องการ snapshot อย่างน้อย 2 สัปดาห์',
  ...
  'ops.outreach-gap.subtitle':
    'F11 อัตราครอบคลุม vs เป้าหมาย · อันดับช่องว่าง CC · ประมาณรายได้ที่เสียไป',
  ...
  'ops.followup-alert.subtitle':
    'F7 นักเรียนชำระที่ยังไม่มีการติดตาม · F10 เปรียบเทียบผลก่อน/หลังเรียน',
  ...
  'ops.kpi-north-star.subtitle':
    'D1 อันดับเช็คอิน · D5 ค่าสัมประสิทธิ์รายเดือน · D1×D5 scatter plot',
  ...
  'biz.overview.action.preCallLift':
    'การโทรก่อนเรียนเพิ่มอัตราเข้าเรียน 2.2x ควรเพิ่มการติดต่อก่อนเรียน',
  ...
  'biz.attribution.label.loadFailed':
    'ยังไม่มีข้อมูลแหล่งที่มา กรุณาเรียกใช้เครื่องมือวิเคราะห์ก่อน',
  ...
  'biz.roi.label.cohortDesc':
    'อัตราการติดต่อลดครึ่งหนึ่งใน ~4 เดือน อัตราการมีส่วนร่วมลดครึ่งหนึ่งใน ~2 เดือน — ROI สูงสุดใน 2 เดือนแรก',
  ...
  'biz.orders.subtitle':
    'สัดส่วนแพ็กเกจ (E6) · โครงสร้างแพ็กเกจกลุ่มย่อย (E7) · Waterfall รายได้ช่องทาง (E8)',
  ...
  'biz.orders.label.e7NoData':
    'E7 ยังไม่ได้เชื่อมต่อ กรุณาตรวจสอบไฟล์ BI-订单_分小组套餐类型占比_D-1',
  ...
  'biz.orders-detail.subtitle':
    'รายได้ตามประเภทผลิตภัณฑ์แบบซ้อน (E4) · Radar กลุ่ม (E7) · Waterfall ช่องทาง (E8)',
  ...
  'biz.leads-detail.label.a2Desc':
    'แถว = ช่วงวันหลังชำระ · คอลัมน์ = ช่องทางลงทะเบียน · สี = อัตราแปลง',
  ...
  'biz.enclosure.label.compareDesc':
    'น้ำเงิน = ช่องทางตลาด · ม่วง = ช่องทางการแนะนำ · เปลี่ยนตัวชี้วัดได้',
  ...
  'biz.enclosure-detail.context.combinedDesc':
    'รวมทุกช่องทาง แสดงนักเรียนที่ active/ชำระ/มีส่วนร่วม/อัตราการดำเนินงานทุกช่วงวัน',
  ...
  'biz.coverage.subtitle':
    'F11 รายละเอียดการโทรก่อนเรียน · ระบุนักเรียนที่ยังไม่ครอบคลุม · ประมาณรายได้ที่เสียไป',
  ...
  'biz.leads-overview.glossary':
    'ช่องทางแคบ=ลิงก์พนักงาน CC/SS/LP | ช่องทางกว้าง=ลิงก์นักเรียน UserA',
  ...
  'biz.leads-overview.section.team_matrix':
    'เมทริกซ์ประสิทธิภาพทีม×ช่องทาง Team Channel Efficiency',
  'biz.leads-overview.section.enclosure_baseline':
    'ความเบี่ยงเบนประสิทธิภาพช่วงวัน Enclosure Efficiency vs Baseline',
  ...
  // ── หน้าเมทริกซ์ตัวชี้วัด ────────────────────────────────────────────────────
  'matrix.title': 'ภาพรวมเมทริกซ์ตัวชี้วัด',
  'matrix.subtitle': 'การกำหนดค่าและเปรียบเทียบขอบเขตตัวชี้วัด CC/SS/LP',
  'matrix.category.result': 'ตัวชี้วัดผล',
  'matrix.category.achievement': 'ตัวชี้วัดความสำเร็จ',
  'matrix.category.process': 'ตัวชี้วัดกระบวนการ',
  'matrix.category.efficiency': 'ตัวชี้วัดประสิทธิภาพ',
  'matrix.category.process_wide': 'ตัวชี้วัดกระบวนการ (กว้าง)',
  'matrix.category.conversion': 'ประสิทธิภาพการแปลง',
  'matrix.category.service_pre_paid': 'ตัวชี้วัดบริการ-ก่อนชำระ',
  'matrix.category.service_post_paid': 'ตัวชี้วัดบริการ-หลังชำระ',
  'matrix.pending': 'รอการเชื่อมต่อข้อมูล',
  'matrix.cc_readonly': 'คอลัมน์ CC ล็อกโดยระบบ เปิดใช้ทั้งหมด',
  'matrix.save': 'บันทึกการตั้งค่า',
  'matrix.reset': 'รีเซ็ต',
  'matrix.export': 'ส่งออก CSV',
};
