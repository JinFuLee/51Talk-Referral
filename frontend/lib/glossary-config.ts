...
export const glossaryConfig: Record<string, GlossaryTerm[]> = {
  ...
  ops_ranking: [
    ...
    { term: "SS", definition: "后端销售（数据别名 EA）" },
    { term: "LP", definition: "后端服务（数据别名 CM）" },
    { term: "综合得分", definition: "过程(25%) + 结果(60%) + 效率(15%) 加权分", formula: "composite = process×0.25 + result×0.60 + efficiency×0.15" },
    { term: "触达率", definition: "有效通话(≥120s)学员 / 有效学员", formula: "触达率 = 有效通话学员数 / 有效学员总数" },
  ...
  ops_kpi_north_star: [
    ...
    { term: "带新系数", definition: "B注册数 / 带来注册的A学员数" },
    { term: "参与率", definition: "带来≥1注册的学员 / 有效学员" },
    { term: "带货比", definition: "推荐注册数 / 有效学员", formula: "带货比 = 推荐注册数 / 有效学员数" },
  ...
  ops_outreach_heatmap: [
    ...
    { term: "有效率", definition: "有效接通数 / 外呼数", formula: "有效率 = 有效接通(≥120s) / 外呼总次数" },
  ],
  ...
  biz_insights: [
    ...
    { term: "MECE", definition: "相互独立、完全穷尽 (Mutually Exclusive, Collectively Exhaustive)" },
  ],
  ...
  biz_impact: [
    ...
    { term: "损失量化", definition: "将效率缺口转化为可量化的美元收入损失", formula: "损失 = gap × 转化链各环节转化率 × 客单价" },
  ...
  biz_cohort_students: [
    ...
    { term: "带新率", definition: "带来≥1个B注册的学员 / 总学员", formula: "带新率 = 带新学员数 / 总学员数" },
