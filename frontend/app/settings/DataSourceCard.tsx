    ...
    <Card title="BI 数据源">
      <div className="space-y-4">
        ...
        <div className="grid grid-cols-2 gap-2 text-xs">
          <div>
            <span className="text-[var(--text-muted)]">平台</span>
            <p className="font-medium text-[var(--text-primary)]">阿里云 Quick BI</p>
          </div>
          <div>
            <span className="text-[var(--text-muted)]">Access Ticket</span>
            <p className="font-mono text-[var(--text-primary)]">
              {data ? ticketPreview(data.dashboard_url) : '…'}
            </p>
          </div>
          <div>
            <span className="text-[var(--text-muted)]">表格数</span>
            <p className="font-medium text-[var(--text-primary)]">
              {data?.tables?.length ?? '…'} 个
            </p>
          </div>
          <div>
            <span className="text-[var(--text-muted)]">上次更新</span>
        ...
        <p className="text-[10px] text-[var(--text-muted)] leading-relaxed">
          Access Ticket 会定期过期。过期后群里会发出新链接，粘贴到上面保存即可。
          脚本自动读取最新链接：
