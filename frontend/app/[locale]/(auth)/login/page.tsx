...
const FEATURES: { icon: string; titleKey: string; descKey: string }[] = [
  { icon: 'chart', titleKey: 'feature1Title', descKey: 'feature1Desc' },
  { icon: 'sparkle', titleKey: 'feature2Title', descKey: 'feature2Desc' },
  { icon: 'activity', titleKey: 'feature3Title', descKey: 'feature3Desc' },
];
            ...
            <div className="space-y-5">
              {FEATURES.map((f, i) => (
                ...
                >
                  ...
                  <div>
                    <h3 className="text-sm font-semibold text-n-800">{t(f.titleKey)}</h3>
                    <p className="text-sm text-n-500 mt-0.5">{t(f.descKey)}</p>
                  </div>
                </div>
              ))}
            </div>
