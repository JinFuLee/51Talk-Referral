  ...
  return (
    <div className="flex items-center justify-center min-h-[60vh]">
      <div className="text-center max-w-md">
        ...
        <p className="text-secondary-token mb-4">{error.message}</p>
        <div className="flex gap-3 justify-center">
          ...
          <button
            ...
            className="px-4 py-2 border border-default-token rounded focus-visible:outline-none focus-visible:ring-2 focus-visible:ring-ring focus-visible:ring-offset-2"
          >
            {t('reload')}
          </button>
        </div>
