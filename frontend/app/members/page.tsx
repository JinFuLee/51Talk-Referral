    ...
    <div className="space-y-6">
      ...
      <div className="flex gap-3 flex-wrap items-center">
        <input
          ...
          className="px-3 py-2 border border-[var(--border-subtle)] rounded-lg text-sm focus:outline-none focus:ring-2 focus:ring-blue-500 w-40"
        />
        <input
          type="text"
          placeholder="CC 筛选"
          ...
          className="px-3 py-2 border border-[var(--border-subtle)] rounded-lg text-sm focus:outline-none focus:ring-2 focus:ring-blue-500 w-36"
        />
        <select
          ...
          className="px-3 py-2 border border-[var(--border-subtle)] rounded-lg text-sm focus:outline-none focus:ring-2 focus:ring-blue-500 bg-[var(--bg-surface)] text-[var(--text-primary)]"
        >
