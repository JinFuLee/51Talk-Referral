...
describe('useConfigStore', () => {
  ...
  describe('initial state', () => {
    it('has default language zh', () => {
      expect(useConfigStore.getState().language).toBe('zh')
    })
  ...
  describe('setLanguage', () => {
    it('switches language to th', () => {
      useConfigStore.getState().setLanguage('th')
      expect(useConfigStore.getState().language).toBe('th')
    })

    it('switches back to zh', () => {
      useConfigStore.getState().setLanguage('th')
      useConfigStore.getState().setLanguage('zh')
      expect(useConfigStore.getState().language).toBe('zh')
    })
  })
  ...
  describe('setConfig', () => {
    ...
    it('updates multiple fields at once', () => {
      useConfigStore.getState().setConfig({ input_dir: '/custom/input', output_dir: '/custom/output' })
      const state = useConfigStore.getState()
