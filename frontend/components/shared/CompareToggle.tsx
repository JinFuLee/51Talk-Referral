          ...
          <button
            ...
            className={
              isActive
                ...
                : 'h-8 px-3 rounded-full text-xs font-semibold bg-slate-50 border border-[var(--border-subtle)] text-[var(--text-secondary)] hover:text-[var(--text-primary)] transition-all'
            }
          >
            {opt.label}
          </button>
