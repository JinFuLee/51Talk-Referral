  ...
  return (
    <div className="flex items-center gap-2">
      <Select value={period} onValueChange={handlePeriodChange}>
        <SelectTrigger className="h-8 w-[120px] rounded-full border border-slate-200 bg-slate-50 px-3 py-0 text-xs font-semibold text-[var(--text-secondary)] shadow-none focus:ring-1 focus:ring-slate-300">
      ...
      {period === "custom" && (
        <div className="flex items-center gap-1">
          <input
            ...
            className="h-8 rounded-lg border border-slate-200 bg-slate-50 px-2 text-xs font-medium text-[var(--text-secondary)] focus:outline-none focus:ring-1 focus:ring-slate-300"
          />
