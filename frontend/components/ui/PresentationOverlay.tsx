  ...
  return (
    <>
      ...
      <div className="absolute top-6 right-8 flex flex-col items-end opacity-40 select-none z-50 pointer-events-none presentation-watermark">
        <span className="text-2xl font-bold tracking-tighter text-primary-token">
          51Talk · 泰国转介绍
        </span>
        ...
        <span className="text-[10px] text-muted-token mt-1 font-mono">
      ...
      <button
        ...
        className="fixed bottom-6 inset-x-0 mx-auto w-max px-6 py-2.5 bg-subtle backdrop-blur-md text-white rounded-full shadow-2xl flex items-center justify-center gap-2 hover:bg-subtle transition-all z-[100] hide-in-presentation-btn"
