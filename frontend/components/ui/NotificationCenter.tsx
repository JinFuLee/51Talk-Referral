...
export function NotificationCenter() {
  ...
  const [notifications, setNotifications] = useState<NotificationItem[]>([
    { id: "1", type: "alert", title: "KPI 红色预警", message: "本月付费转化率低至 12%，远低于目标 18%", timestamp: "10分钟前", read: false },
    { id: "2", type: "warning", title: "零跟进预警", message: "王明有 5 个分配的体验课超过 24 小时未跟进", timestamp: "1小时前", read: false },
    { id: "3", type: "info", title: "报表生成完毕", message: "本周全区复盘简报已生成", timestamp: "5小时前", read: true },
  ]);
          ...
          <div className="max-h-[320px] overflow-y-auto">
            {filtered.length === 0 ? (
              ...
              <div className="divide-y divide-slate-100">
                {filtered.map(n => (
                  <div key={n.id} className={`p-4 transition-colors hover:bg-slate-50/50 ${!n.read ? "bg-brand-50/30" : ""}`}>
