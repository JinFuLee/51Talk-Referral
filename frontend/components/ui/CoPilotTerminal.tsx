  ...
  const handleSend = async () => {
    ...
    setTimeout(() => {
      ...
      setMessages(prev => [...prev, { 
        ...
        role: "assistant", 
        content: "I've analyzed the recent snapshots via MCP. It appears there's a 15% drop in D61-90 enclosure conversions specifically for the SS team due to lower outreach compliance. I recommend triggering a targeted Reactivation campaign. Shall I draft the campaign brief?"
      }]);
    }, 1500);
  };
  ...
  return (
    <>
      ...
      <button
        ...
        className={cn(
          "fixed bottom-6 right-6 p-4 rounded-full bg-slate-900 text-white shadow-xl hover:shadow-2xl hover:-translate-y-1 transition-all duration-300 z-50 flex items-center justify-center",
