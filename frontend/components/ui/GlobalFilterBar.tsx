    ...
    <div className="sticky top-0 z-40 w-full bg-white/90 backdrop-blur-md border-b border-slate-200 shadow-sm flex-shrink-0">
      ...
      <div className={`md:flex items-center justify-between px-4 py-2.5 transition-all duration-300 origin-top overflow-hidden ${isMobileOpen ? 'max-h-64 opacity-100' : 'max-h-0 opacity-0 md:max-h-full md:opacity-100'}`}>
        ...
        <div className="relative w-full md:w-64 mt-4 md:mt-0">
          ...
          <input 
            type="text" 
            className="bg-slate-50 border border-slate-200 text-slate-900 text-sm rounded-full focus:ring-2 focus:ring-brand-500/20 focus:border-brand-500 block w-full pl-9 pr-4 py-1.5 outline-none transition-all placeholder:text-slate-400" 
