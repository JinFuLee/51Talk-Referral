  ...
  return (
    <div className={`flex items-center gap-1 ${className}`}>
      <input
        ...
        step={step}
        min={min}
        className="w-24 px-2 py-1 border border-[var(--border-subtle)] rounded text-sm text-right focus:outline-none focus-visible:ring-2 focus-visible:ring-brand-500"
      />
