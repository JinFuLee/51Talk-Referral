          ...
          <div key={cc} className="flex items-center hover:bg-neutral-50 group">
            ...
            {cols.map((seg) => {
              ...
              return (
                <div
                  key={seg}
                  className="flex-shrink-0 flex items-center justify-center text-[10px] font-mono cursor-pointer border border-white/10 transition-all hover:ring-1 hover:ring-blue-400 hover:z-10"
                  style={{
                    width: CELL_W,
                    height: CELL_H,
                    backgroundColor: bg,
