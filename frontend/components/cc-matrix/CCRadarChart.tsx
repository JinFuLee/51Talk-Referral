...
export function CCRadarChart({ data, onClose }: CCRadarChartProps) {
  ...
  return (
    <div className="fixed inset-0 z-50 flex items-center justify-center bg-black/40 backdrop-blur-sm">
      <div className="bg-white border border-neutral-300 rounded-xl shadow-2xl p-5 w-[360px]">
        <div className="flex items-center justify-between mb-3">
          <h3 className="text-sm font-semibold text-neutral-800">{data.cc_name} — 5 维战力图</h3>
          <button
            onClick={onClose}
            className="text-neutral-500 hover:text-neutral-800 text-lg leading-none transition-colors"
            aria-label="关闭"
          >
            ×
          </button>
        ...
        <div className="grid grid-cols-3 gap-1 mt-2">
          {LABELS.map(({ key, label }) => (
            <div key={key} className="text-center">
              ...
              <div className="text-sm font-semibold font-mono text-neutral-800">
