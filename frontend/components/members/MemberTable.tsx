        ...
        <table className="w-full text-sm">
          <thead>
            <tr className="bg-[var(--n-800)] text-white text-xs font-medium">
              ...
              <th className="py-1.5 px-2 border-0 text-right whitespace-nowrap" title="本月打卡天数（转介绍活跃度）">打卡天</th>
              <th className="py-1.5 px-2 border-0 text-right whitespace-nowrap" title="本月课耗（学员活跃度）">课耗</th>
              <th className="py-1.5 px-2 border-0 text-right whitespace-nowrap" title="本月转码次数（分享活跃度）">转码</th>
              <th className="py-1.5 px-2 border-0 text-left whitespace-nowrap" title="推荐奖励领取状态">奖励状态</th>
              <th className="py-1.5 px-2 border-0 text-right whitespace-nowrap" title="次卡距到期天数（流失风险）">卡到期</th>
              <th className="py-1.5 px-2 border-0 text-left whitespace-nowrap" title="CC末次拨打日期（触达及时性）">末次拨打</th>
            </tr>
          </thead>
          <tbody>
            {items.map((m) => {
              ...
              return (
                ...
                >
                  <td className="py-1 px-2 text-xs text-blue-600 font-medium tabular-nums whitespace-nowrap">{m.id}</td>
